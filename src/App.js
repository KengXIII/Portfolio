...
const resumeLink = 'https://drive.google.com/file/d/1Ya-DNdDEFpfPArRO2hnfr6nOmbssvE1u/view?usp=sharing'
const githubLink = 'https://github.com/KengXIII'
const linkedinLink = 'https://www.linkedin.com/in/liao-keng-i/'
        ...
        <div className='max-w-7xl mx-auto py-2 items-end'>
          <div className='flex justify-between sm:justify-center flex-wrap gap-y-4 lg:gap-y-0'>
            ...
            <div className="hidden lg:flex justify-around items-center align-self-end text-[#E8EDF0] text-xs sm:text-lg">
              ...
              <a href={resumeLink} target="_blank" rel="noopener noreferrer" className='mx-3 px-3 py-0.5 rounded-md bg-gradient-to-br from-pink-700 to-orange-500 hover:bg-gradient-to-bl hover:drop-shadow-3xl' onClick={() => sendEvent('Resume')}><span className='text-base sm:text-2xl'>R</span>esume</a>
            </div>
            {menu ?
              <div id='menu' className='flex flex-col justify-center items-center absolute top-20 right-0 w-2/5 md:w-1/5 p-4 z-20 bg-slate-500 gap-y-1 shadow-md bg-opacity-80 rounded-md tracking-wider'>
                ...
                <a href={resumeLink} target="_blank" rel="noopener noreferrer" className='px-3 py-0.5 rounded-md bg-gradient-to-br from-pink-700 to-orange-500 hover:bg-gradient-to-bl hover:drop-shadow-3xl' onClick={() => sendEvent('Resume Mobile')}><span className='text-base sm:text-2xl'>R</span>esume</a>
              </div>
              : null}
          </div>
        </div>
          ...
          <div className='flex h-full grow'>
            <div className='w-[32px]'>
              <div className='flex h-full flex-col justify-end'>
                <a href={githubLink} onClick={() => sendEvent('GitHub')} target="_blank" rel="noopener noreferrer" className='my-3'>
                ...
                <a href={linkedinLink} onClick={() => sendEvent('LinkedIn')} target="_blank" rel="noopener noreferrer" className='my-3'>
