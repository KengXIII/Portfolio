    ...
    return (
        <div>
            <div className='flex flex-col h-[75vh]'>
                <h1 className='text-center text-4xl sm:text-6xl font-bold'>My Experience</h1>
                <div className='relative flex flex-row h-3/4 sm:h-full overflow-x-auto snap-x snap-mandatory sm:snap-proximity bg-[#2c3d4f] sm:m-8 shadow-[3px_3px_6px_0px_inset_rgb(36,50,64),-3px_-3px_6px_1px_inset_rgba(36,50,64,0.3)] rounded-lg select-none'>
                    ...
                    <div className="relative flex flex-col sm:items-end shrink-0 w-[60vw] sm:w-96 h-full snap-center mx-16">
                        <div className="relative flex flex-col h-4/6 my-auto sm:w-3/4 rounded-xl overflow-clip text-slate-600 text-xs shadow-[-5px_5px_rgb(253,126,20,0.3),-10px_10px_rgba(253,126,20,0.2),-15px_15px_rgba(253,126,20,0.1),-20px_20px_rgba(253,126,20,0.05),7.5px_0px_5px_0px_rgba(0,0,0,0.3)] z-10">
